...
namespace SwipeCSAT.Api.Endpoints
{
    ...
    public static class ProductsEndpoints
    {
        ...
        public static RouteGroupBuilder MapProductsEndpoints(this WebApplication app)
        {
            ...
            {
                var productEntity = await productRepository.AddProduct(createProductDto.Name, createProductDto.CategoryName, createProductDto.Description);
            ...
            group.MapPatch("/{name}", async (string name, HttpRequest request, ProductRepository productRepository, SwipeCSATDbContext context) =>
            {
